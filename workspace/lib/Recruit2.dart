...
class Recruit2 extends StatelessWidget {
    ...
    return Scaffold(
          ...
          Pinned.fromPins(
            ...
            child: IconButton(
              ...
              onPressed: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => SearchTabBoard2(RSCOLNAME, "스터디모집", TITLE,CONDITION, userEmail))
                    ...
                    children: [{}].map((itemData) {
                      return SizedBox(
                        ...
                        child: StreamBuilder<QuerySnapshot>(
                          ...
                          stream: FirebaseFirestore.instance.collection(RSCOLNAME).orderBy("시간",descending: true).snapshots(),
                                    ...
                                    return Expanded(
                                      child: InkWell(
                                        ...
                                        onTap: () {
                                          ...
                                          Navigator.push(
                                            context,
                                            MaterialPageRoute(builder: (context) => Recruit_page("스터디 모집",document[TITLE],document[CONDITION],document[MAX_PERSONNEL],document[CURRENT_PERSONNEL],document[DESCRIPTION],document[TIME], userEmail: userEmail,)),
                                          );
                                        },
      ...
      floatingActionButton :FloatingActionButton(
        ...
        onPressed: () {
          Navigator.push(
            context,
              MaterialPageRoute(builder: (context) => RecruitWrite_Study(userEmail:userEmail))
          );
        },
      ),
    );
