...
import 'package:hanmodumo/ContactDirectorySchoolNumber.dart';
...
class ContactDirectoryProffessor extends StatelessWidget {
          ...
          Pinned.fromPins(
            ...
            child: IconButton(
              ...
              onPressed: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => MyAppSearch(colName,BigName,PhoneNumber))
                );
              },
            ),
          ),
          ...
          Pinned.fromPins(
            ...
            child: TextButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => ContactDirectorySchoolNumber()),
                );
              },
            child: Text(
              '교내',
