...
class LectureListWriteFlutterLayout extends StatefulWidget {
  LectureListWriteFlutterLayout(this.boardName, this.colName, this.userEmail,{
    Key? key, required this.thisID, required this.thisID2,
  }) : super(key: key);

  final String thisID;//교과목코드-
  final String thisID2;//학부
  String boardName;
  String colName;
  var userEmail;
  @override
  State<LectureListWriteFlutterLayout> createState() => _MyLectureListWriteFlutterLayout(boardName,colName,userEmail,thisID, thisID2);
}

class _MyLectureListWriteFlutterLayout extends State<LectureListWriteFlutterLayout> {
...
// 필드명
  ...
  _MyLectureListWriteFlutterLayout(this.boardName,this.colName,this.userEmail,this.thisID,this.thisID2);
              ...
              child: IconButton(
                ...
                onPressed: () async {
                  ...
                  {createDoc(_newTitleCon.text, _newContentCon.text, documentCount, now, 0,
                      0, "Y", userEmail, _pickedImgs.length, thisID, thisID2, 0,colName,boardName);
                  _uploadVote();
                  }
                  else if(!_Votevisibility)
                  {createDoc(_newTitleCon.text, _newContentCon.text, documentCount, now, 0,
                      0, "N", userEmail, _pickedImgs.length, thisID, thisID2, 0,colName, boardName);}
                  _newTitleCon.clear();
